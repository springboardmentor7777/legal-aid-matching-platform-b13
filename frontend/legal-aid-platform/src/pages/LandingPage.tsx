      ...
      <section className="relative bg-black text-white overflow-hidden">
        <div className="container mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="max-w-2xl z-10">
            ...
            <TypeAnimation
              sequence={[
                "We connect you with the justice...",
                1000,
                "Supported By NGOs",
                1000,
              ]}
              className="font-mono text-4xl md:text-5xl font-extrabold mb-6 leading-tight"
              wrapper="span"
              speed={30}
              repeat={Infinity}
            />
            <p className="text-lg md:text-xl text-blue-100 mb-8 leading-relaxed">
              Legal aid matching platform, Trusted by verified lawyers, NGOs and
      ...
      <section className="bg-gray-900 py-4">
        <div className="container mx-auto px-4">
          <div className="relative h-64 md:h-96 rounded-2xl overflow-hidden shadow-2xl group">
            ...
            <button
              onClick={prevSlide}
              className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/40 p-2 rounded-full text-white backdrop-blur-sm transition-all opacity-0 group-hover:opacity-100"
            >
              <LuChevronLeft size={24} />
            </button>
            <button
              onClick={nextSlide}
              className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/40 p-2 rounded-full text-white backdrop-blur-sm transition-all opacity-0 group-hover:opacity-100"
            >
        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              The Legal-Aid Matching Platform is an initiative dedicated to
              democratizing access to justice. We believe that quality legal
              representation should not be a privilege but a fundamental right.
            </p>
            <p className="text-gray-700 text-lg leading-relaxed mb-8">
              By leveraging technology, we bridge the gap between underserved
              communities and legal professionals willing to offer their
              expertise pro bono or at reduced costs.
            </p>
          ...
          <div className="space-y-6">
            <div className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Simply sign up as a citizen, submit your case details, and our
                smart matching system will recommend suitable lawyers based on
                your needs. You can also browse our directory.
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Registration is free for all users. Many lawyers on our platform
                offer pro bono (free) services for eligible citizens. Fees for
                other services are transparently discussed between you and the
                lawyer.
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                We strictly verify every lawyer's credentials with the Bar
                Council before their profile goes live. NGOs are also verified
            ...
            <div className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                ...
                personal information and case details. Your privacy is our top
                priority.
              </p>
            </div>
          </div>
      ...
      <footer id="contact" className="bg-blue-950 text-white pt-16 pb-8">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-blue-200 mb-6 max-w-md">
                Empowering citizens with legal knowledge and access to justice.
                Join us in building a fairer society for everyone.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-blue-200">
                <li className="flex items-start gap-3">
                  <span>📧</span>
                  <a
                    href="mailto:support@legalaidplatform.com"
                    className="hover:text-white transition-colors"
                  >
                    support@legalaidplatform.com
                  </a>
                </li>
                <li className="flex items-start gap-3">
                  <span>📍</span>
                  <span>
                    123 Justice Lane, Legal District, New Delhi, India
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span>📞</span>
          ...
          <div className="border-t border-blue-900 pt-8 text-center text-blue-300 text-sm">
            <p>
              © {new Date().getFullYear()} Legal-Aid Matching Platform. All
              rights reserved.
            </p>
