...
export default function NGOIngest() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:8081/directory/external/ngos/upload", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white border rounded-lg shadow-sm">
      <h2 className="text-xl font-bold mb-4 text-gray-800">Upload Ngo Directory</h2>
